...
| `style` | `nestedList` | Table of contents style (can be `nestedList`, `nestedOrderedList` or `nestedListTask`, `nestedOrderedListTask` or |
...
- The table of contents is based on a codeblock so it can be updated; it doesn't generate real Markdown in the document (see [#10](https://github.com/johansatge/obsidian-automatic-table-of-contents/issues/10#issuecomment-2676779810)) so it won't be visible when exporting, or on Obsidian Publish (see [#31](https://github.com/johansatge/obsidian-automatic-table-of-contents/issues/31)) and links might not work in PDFs (see [#12](https://github.com/johansatge/obsidian-automatic-table-of-contents/issues/12))
...
| Version | Date | Notes |
| --- | --- | --- |
| `1.8.0` | 2026-02-07 | Introduce global settings ([@stevedoyle](https://github.com/stevedoyle)) (fix #38, #83) |
